...
import PpFcab from "./pages/PpFcab";
import PpEprime from "./pages/PpEprime";
...
function AppRouter() {
  ...
  return (
    <Routes>
      ...
      <Route path="/pp-fcab" element={<PpFcab />} />
      <Route path="/pp-eprime" element={<PpEprime />} />
      ...
      <Route path="/admin" element={
        ...
        <Route path="mandantes/:mandanteId/standard" element={<AdminMandanteStandard />} />
        <Route path="gerencias" element={<AdminGerencias />} />
        <Route path="certificates" element={<AdminCertificates />} />
        <Route path="reports" element={<AdminReports />} />
        <Route path="reports/competency-matrix" element={<AdminCompetencyMatrix />} />
